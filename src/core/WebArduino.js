+(function (factory) {
  ...
  proto.queryCapabilities = function () {
    var msg = [
      ...
      8, 4, 14, 127, 0, 1, 1, 1, 4, 14, 127, 0, 1, 1, 1, 3,
      8, 4, 14, 127, 0, 1, 1, 1, 3, 8, 4, 14, 127, 0, 1, 1,
      1, 4, 14, 127, 0, 1, 1, 1, 4, 14, 127, 0, 1, 1, 1, 3,
      8, 4, 14, 127, 0, 1, 1, 1, 3, 8, 4, 14, 127, 0, 1, 1,
      1, 3, 8, 4, 14, 127, 0, 1, 1, 1, 4, 14, 127, 0, 1, 1,
      1, 4, 14, 127, 0, 1, 1, 1, 2, 10, 4, 14, 127, 0, 1, 1,
      1, 2, 10, 4, 14, 127, 0, 1, 1, 1, 2, 10, 4, 14, 127, 0,
      1, 1, 1, 2, 10, 4, 14, 127, 0, 1, 1, 1, 2, 10, 4, 14,
      6, 1, 127, 0, 1, 1, 1, 2, 10, 4, 14, 6, 1, 127, 2, 10,
      127, 2, 10, 127, 247
    ];
    mockMessageEvent(this, msg);
  };
